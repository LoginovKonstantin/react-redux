									...
									.map(n => {
										...
										return (
											<TableRow
												...
												selected={isSelected}
											>
												<TableCell onClick={() => browserHistory.push('/edit/groups/'+n.id)} style={{width:30}} numeric>{n.id}</TableCell>
...
EnhancedTable.propTypes = {
	...
	groupTable: PropTypes.array.isRequired
};
